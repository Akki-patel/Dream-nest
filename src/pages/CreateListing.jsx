...
import { RemoveCircleOutline, AddCircleOutline, IndeterminateCheckBoxOutlined } from '@mui/icons-material';
...
const CreateListing = () => {
    ...
    // description section
    const [formDescription, setFormDecription] = useState({
        title: "",
        description: "",
        highlight: "",
        highlightDesc: "",
    ...
    const handlePost = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://dreamnest-be.onrender.com/properties/create", {
                method: "POST",
                body: listingForm
            })
            if (response.ok) {
                    ...
                    <div className='create-listing_step2'>
                        ...
                        <div className='amenities'>
                            {facilities?.map((item, index) => (
                                <div className={`facility ${amenities.includes(item.name) ? "selected" : " "}`} key={index} onClick={() => handleSelectedAmenities(item.name)}>
                        ...
                        <h3>What make your place attractive and exciting?
                        </h3>

                        <div className='description'>
                            <p>Title</p>
                            <input type='text' placeholder='Title' name='title' value={formDescription.title} onChange={handleChangeDescription}
                                required />
                            <p>Desciption</p>
                            <textarea type='text' placeholder='Descritption' name='description' value={formDescription.description} onChange={handleChangeDescription} required />
                            <p>Highlight</p>
